    ...
    <div>
      ...
      <main>
        ...
        <ul>
          {" "}
          <li>
            <a href="https://www.nytimes.com/interactive/2024/upshot/buy-rent-calculator.html?buyGrowthRate=0.033&amp;investmentReturnRate=0.085">
              NYT – After
            </a>
          </li>{" "}
          <li>
            <a href="https://www.nytimes.com/interactive/2024/upshot/buy-rent-calculator.html">
              NYT – Before
            </a>
          </li>{" "}
          <li>
            <a href="https://www.nerdwallet.com/calculator/rent-vs-buy-calculator">
              NerdWallet
            </a>
          </li>{" "}
        </ul>{" "}
